...
Page({
  ...
  lock_addcard: function (e) {
    //mypage.setData({ motto: "test" })
    console.log(e.detail.value);
    var lockId = wx.getStorageSync('addCardLockId')
    ...
    myProcess.addlockcard(lockId, e.detail.value["name"], e.detail.value["starttime"], e.detail.value["endtime"], function(e){
